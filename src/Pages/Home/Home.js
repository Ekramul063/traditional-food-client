    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-5 gap-5 px-8">
                {
                    singleDisctrict.map((district,i) =><div key={i} className=' text-secondary font-bold cursor-pointer hover:shadow-lg hover:bg-primary border flex justify-center items-center p-5 '><h3>{district}</h3></div>)
                }
